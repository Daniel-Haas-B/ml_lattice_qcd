...
sum_t1 = np.sum(epsilon_t1_burn1)
sum_t2 = np.sum(epsilon_t24_burn1)

mean_t1 = sum_t1 / len(epsilon_t1_burn1)
mean_t2 = sum_t2 / len(epsilon_t24_burn1)

dev_t1 = (epsilon_t1_burn1 - mean_t1)**2
dev_t2 = (epsilon_t24_burn1 - mean_t2)**2

var_t1 = np.sum(dev_t1)/len(epsilon_t1_burn1)
var_t2 = np.sum(dev_t2)/len(epsilon_t24_burn1)
